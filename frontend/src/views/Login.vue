  ...
  <div class="h-full flex items-center justify-center">
    <div class="w-full max-w-md p-8 rounded-2xl glass-card border border-slate-800/60 shadow-2xl relative overflow-hidden">
      ...
      <div class="text-center mb-8 relative">
        <h2 class="text-2xl font-bold bg-gradient-to-r from-slate-100 to-slate-300 bg-clip-text text-transparent">Welcome back</h2>
      ...
      <div class="mt-8 text-center text-sm text-slate-400">
        ...
        <router-link to="/register" class="text-brand-400 hover:text-brand-300 font-semibold transition ml-1">Sign Up</router-link>
      </div>
    </div>
  </div>
</template>
